...
from transformers import (
    ...
    AutoConfig,
    AutoModelForCausalLM, GPT2LMHeadModel, GPT2Config, 
    HfArgumentParser,
    # Trainer,
    TrainingArguments,
...
class ModelArguments:
    ...
    """
    trainer_class: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                ""
...
def main():
    ...
    if model_args.trainer_class == 'trainer_mcts':
        from trainer import TrainerMCTS as Trainer
    elif model_args.trainer_class == 'trainer_valid':
        from trainer import TrainerValid as Trainer
    else:
    ...
    if model_args.tokenizer_name:
        tokenizer = Tokenizer.from_pretrained(model_args.tokenizer_name)
